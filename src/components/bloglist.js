               ...
               { BlogData }
                  ...
                  <div className="col-md-12">
                    <div className="blog-entry d-md-flex ftco-animate fadeInUp ftco-animated">
                      ...
                      <div className="text text-2 pl-md-4">
                        <h3 className="mb-2">
                          <a href="#">Paths Are Made by Walking</a>
                        </h3>
                        <div className="meta-wrap">
                          <p className="meta">
                  ...
                  <div className="col-md-12">
                    <div className="blog-entry d-md-flex ftco-animate fadeInUp ftco-animated">
                      <a
                        ...
                        className="img img-2"
                        style={{
                          backgroundImage: "url(" + "images/image_7.jpg" + ")"
                        }}
                      ></a>
                      <div className="text text-2 pl-md-4">
                        <h3 className="mb-2">
                  ...
                  <div className="col-md-12">
                    <div className="blog-entry d-md-flex ftco-animate fadeInUp ftco-animated">
                      <a
                        ...
                        className="img img-2"
                        style={{
                          backgroundImage: "url(" + "images/image_8.jpg" + ")"
                        }}
                      ></a>
                      <div className="text text-2 pl-md-4">
                        <h3 className="mb-2">
                  ...
                  <div className="col-md-12">
                    <div className="blog-entry d-md-flex ftco-animate fadeInUp ftco-animated">
                      <a
                        ...
                        className="img img-2"
                        style={{
                          backgroundImage: "url(" + "images/image_11.jpg" + ")"
                        }}
                      ></a>
                      <div className="text text-2 pl-md-4">
                        <h3 className="mb-2">
                  ...
                  <div className="col-md-12">
                    <div className="blog-entry d-md-flex ftco-animate fadeInUp ftco-animated">
                      <a
                        ...
                        className="img img-2"
                        style={{
                          backgroundImage: "url(" + "images/image_12.jpg" + ")"
                        }}
                      ></a>
                      <div className="text text-2 pl-md-4">
                        <h3 className="mb-2">
