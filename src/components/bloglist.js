                        ...
                        <div className="row d-flex">
                                ...
                                <div className="row pt-md-4">
                                    <div className="col-md-12">
                                            <div className="blog-entry ftco-animate fadeInUp ftco-animated">
                                                <a href="#" className="img img-2"></a>
                                                <div className="text text-2 pl-md-4">
                                    <h3 className="mb-2"><a href="#">A Loving Heart is the Truest Wisdom</a></h3>
                                    <div className="meta-wrap">
                                                        <p className="meta">
                                            <span><i className="icon-calendar mr-2"></i>June 28, 2019</span>
                                            <span><a href="#"><i className="icon-folder-o mr-2"></i>Travel</a></span>
                                    ...
                                    <p><a href="#" className="btn-custom">Read More <span className="ion-ios-arrow-forward"></span></a></p>
                                        ...
                                        <div className="col-md-12">
                                            <div className="blog-entry ftco-animate fadeInUp ftco-animated">
                                                <a href="#" className="img img-2"></a>
                                                <div className="text text-2 pl-md-4">
                                    <h3 className="mb-2"><a href="#">Great Things Never Came from Comfort Zone</a></h3>
                                    <div className="meta-wrap">
                                                        <p className="meta">
                                            <span><i className="icon-calendar mr-2"></i>June 28, 2019</span>
                                            <span><a href="#"><i className="icon-folder-o mr-2"></i>Travel</a></span>
                                    ...
                                    <p><a href="#" className="btn-custom">Read More <span className="ion-ios-arrow-forward"></span></a></p>
                                        ...
                                        <div className="col-md-12">
                                            <div className="blog-entry ftco-animate fadeInUp ftco-animated">
                                                <a href="#" className="img img-2"></a>
                                                <div className="text text-2 pl-md-4">
                                    <h3 className="mb-2"><a href="#">Paths Are Made by Walking</a></h3>
                                    <div className="meta-wrap">
                                                        <p className="meta">
                            ...
                            <div className="col-xl-4 sidebar ftco-animate bg-light pt-5 fadeInUp ftco-animated">
                                ...
                                <div className="block-21 mb-4 d-flex">
                                    ...
                                    <div className="text">
                                    <h3 className="heading"><a href="#">Even the all-powerful Pointing as no control</a></h3>
                                    <div className="meta">
